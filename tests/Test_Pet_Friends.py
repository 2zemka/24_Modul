...
def test_post_new_pet_with_valid_data(name="Mira", animal_type="Fish",
                                      age='1', pet_photo="Mira.jpg"):
...
def test_add_photo_to_pet_with_valid_data(self, pet_photo="images/Sfinx_canadianL.jpg"):
...
def test_get_api_key_for_invalid_user_valid_password(email="melkiibk@ya.ru", password=valid_password):
...
def test_create_pet_simple_wrong_age(name="Тортилла", animal_type="черепаха", age="очень много"):
    '''Добавление питомца (без фото) с неверно написанным возрастом.
